...
all_train_des = np.load('./BoWdata/save/test_des_3.npy')
...
np.save('./BoWdata/save/histogram_test_SPM1.npy',histogram1)
np.save('./BoWdata/save/histogram_test_SPM2.npy',histogram2)
np.save('./BoWdata/save/histogram_test_SPM3.npy',histogram3)
np.save('./BoWdata/save/histogram_test_SPM4.npy',histogram4)
np.save('./BoWdata/save/histogram_test_SPM5.npy',histogram5)
np.save('./BoWdata/save/histogram_test_SPM6.npy',histogram6)
np.save('./BoWdata/save/histogram_test_SPM7.npy',histogram7)
